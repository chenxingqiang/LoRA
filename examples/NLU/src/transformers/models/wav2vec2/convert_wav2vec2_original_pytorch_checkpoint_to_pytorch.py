    ...
    for name, value in fairseq_dict.items():
        ...
        if "conv_layers" in name:
            ...
            for key, mapped_key in MAPPING.items():
                mapped_key = "wav2vec2." + \
                    mapped_key if (is_finetuned and mapped_key !=
                                   "lm_head") else mapped_key
                ...
                if key in name or (key.split("w2v_model.")[-1] == name.split(".")[0] and not is_finetuned):
                    ...
                    if "weight_g" in name:
                        ...
                        weight_type = None
                    set_recursively(hf_model, mapped_key,
                                    value, name, weight_type)
                continue
        if not is_used:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint_path", default=None,
                        type=str, help="Path to fairseq checkpoint")
    parser.add_argument("--dict_path", default=None, type=str,
