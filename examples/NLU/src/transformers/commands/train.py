...
class TrainCommand(BaseTransformersCLICommand):
    ...
    def register_subcommand(parser: ArgumentParser):
        ...
        train_parser.add_argument(
            "--validation_data", type=str, default="", help="path to validation dataset.")
        train_parser.add_argument(
            "--validation_split",
            type=float,
            default=0.1,
        ...
        train_parser.add_argument(
            "--valid_batch_size", type=int, default=64, help="Batch size for validation.")
        train_parser.add_argument(
            "--learning_rate", type=float, default=3e-5, help="Learning rate.")
        train_parser.add_argument(
            "--adam_epsilon", type=float, default=1e-08, help="Epsilon for Adam optimizer.")
    ...
    def __init__(self, args: Namespace):
        ...
        self.logger.info(
            "Loading {} pipeline for {}".format(args.task, args.model))
        ...
        if args.validation_data:
            self.logger.info(
                "Loading validation dataset from {}".format(args.validation_data))
