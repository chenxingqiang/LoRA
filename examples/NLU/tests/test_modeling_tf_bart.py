...
class TFBartHeadTests(unittest.TestCase):
    ...
    def test_lm_forward(self):
        ...
        outputs = lm_model(input_ids=input_ids, labels=decoder_lm_labels,
                           decoder_input_ids=input_ids, use_cache=False)
    ...
    def test_lm_uneven_forward(self):
        ...
        outputs = lm_model(input_ids=context,
                           decoder_input_ids=summary, use_cache=False)
...
class TFBartModelIntegrationTest(unittest.TestCase):
    def test_inference_no_head(self):
        ...
        attention_mask = tf.cast(tf.math.not_equal(
            input_ids, model.config.pad_token_id), tf.int8)
    ...
    def test_cnn_summarization_same_as_fairseq_hard(self):
        ...
        assert hypotheses_batch[:, 1].numpy().tolist() == [0, 0, 0, 0]
...
class FasterTFBartModelIntegrationTests(unittest.TestCase):
    ...
    def test_encoder_equiv(self):
        ...
        expected = np.array([[-0.0828, -0.0251, -0.0674],
