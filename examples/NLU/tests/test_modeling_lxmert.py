...
class LxmertModelTester:
    ...
    def prepare_config_and_inputs(self):
        ...
        visual_feats = torch.rand(
            self.batch_size, self.num_visual_features, self.visual_feat_dim, device=torch_device)
    ...
    def resize_lxmert_num_qa_labels(
        ...
        self.parent.assertEqual(
            result_pretrain.question_answering_score.shape, (self.batch_size, start_labels))
        self.parent.assertEqual(
            result_qa_less.question_answering_score.shape, (self.batch_size, num_small_labels))
        self.parent.assertEqual(
            result_pretrain_less.question_answering_score.shape, (
                self.batch_size, num_small_labels)
        )
        self.parent.assertEqual(
            result_qa_more.question_answering_score.shape, (self.batch_size, num_large_labels))
        self.parent.assertEqual(
...
class LxmertModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    all_model_classes = (LxmertModel, LxmertForPreTraining,
