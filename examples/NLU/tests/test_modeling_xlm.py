...
class XLMModelTester:
    ...
    def prepare_config_and_inputs_for_common(self):
        ...
        inputs_dict = {"input_ids": input_ids,
                       "token_type_ids": token_type_ids, "lengths": input_lengths}
...
class XLMModelTest(ModelTesterMixin, GenerationTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config_tester = ConfigTester(
            self, config_class=XLMConfig, emb_dim=37)
...
class XLMModelLanguageGenerationTest(unittest.TestCase):
    ...
    def test_lm_generate_xlm_mlm_en_2048(self):
        ...
        input_ids = torch.tensor(
            [[14, 447]], dtype=torch.long, device=torch_device)  # the president
        expected_output_ids = [
            14,
            447,
            14,
        ...
        self.assertListEqual(
            output_ids[0].cpu().numpy().tolist(), expected_output_ids)
