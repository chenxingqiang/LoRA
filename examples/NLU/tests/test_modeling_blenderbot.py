...
class BlenderbotModelTester:
    ...
    def check_encoder_decoder_model_standalone(self, config, inputs_dict):
        ...
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            encoder = BlenderbotEncoder.from_pretrained(
        ...
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            decoder = BlenderbotDecoder.from_pretrained(
                tmpdirname).to(torch_device)
...
class BlenderbotModelTest(ModelTesterMixin, GenerationTesterMixin, unittest.TestCase):
    all_model_classes = (
        BlenderbotModel, BlenderbotForConditionalGeneration) if is_torch_available() else ()
...
class Blenderbot3BIntegrationTests(unittest.TestCase):
    ...
    def test_generation_from_short_input_same_as_parlai_3B(self):
        ...
        generated_utterances = model.generate(
            **model_inputs, **FASTER_GEN_KWARGS)
