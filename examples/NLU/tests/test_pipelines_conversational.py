...
class SimpleConversationPipelineTests(unittest.TestCase):
    ...
    def test_integration_torch_conversation(self):
        ...
        result = conversation_agent(
            [conversation_1, conversation_2], max_length=48)
        ...
        self.assertEqual(
            ...
            Conversation(
                None,
                past_user_inputs=[
                    "What's the last book you have read?", "Why do you recommend it?"],
...
class ConversationalPipelineTests(MonoInputPipelineCommonMixin, unittest.TestCase):
    ...
    def _test_pipeline(
        ...
        conversations = [Conversation(
            "Hi there!"), Conversation("How are you?")]
    ...
    def test_integration_torch_conversation(self):
        ...
        result = nlp([conversation_1, conversation_2],
                     do_sample=False, max_length=1000)
        # Then
        self.assertEqual(result, [conversation_1, conversation_2])
        ...
        self.assertEqual(
            result.past_user_inputs[1], "Why do you recommend it?")
    ...
    def test_integration_torch_conversation_truncated_history(self):
        ...
        nlp = pipeline(task="conversational",
                       min_length_for_response=24, device=DEFAULT_DEVICE_NUM)
        conversation_1 = Conversation(
            "Going to the movies tonight - any suggestions?")
        # Then
        self.assertEqual(len(conversation_1.past_user_inputs), 0)
    ...
    def test_integration_torch_conversation_dialogpt_input_ids(self):
        ...
        conversation_2 = Conversation("how are you ?", past_user_inputs=[
                                      "hello"], generated_responses=["Hi there!"])
        inputs = nlp._parse_and_tokenize([conversation_2])
        self.assertEqual(
            inputs["input_ids"].tolist(), [[31373, 50256, 17250, 612, 0,
                                            50256, 4919, 389, 345, 5633, 50256]]
        )
        ...
        self.assertEqual(
            ...
            [
                [31373, 50256, 50256, 50256, 50256, 50256,
