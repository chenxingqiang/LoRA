...
class XLMRobertaModelIntegrationTest(unittest.TestCase):
    ...
    def test_xlm_roberta_base(self):
        ...
        expected_output_values_last_dim = torch.tensor(
            [[-0.0101, 0.1218, -0.0803, 0.0801, 0.1327, 0.0776, -
                0.1215, 0.2383, 0.3338, 0.3106, 0.0300, 0.0252]]
        )
        ...
        self.assertTrue(torch.allclose(
            output[:, :, -1], expected_output_values_last_dim, atol=1e-3))
    ...
    def test_xlm_roberta_large(self):
        ...
        expected_output_values_last_dim = torch.tensor(
            [[-0.0699, -0.0318, 0.0705, -0.1241, 0.0999, -0.0520,
                0.1004, -0.1838, -0.4704, 0.1437, 0.0821, 0.0126]]
        )
