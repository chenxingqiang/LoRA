...
def main():
    ...
    parser.add_argument("--model_name", type=str,
                        default="openai-gpt", help="pretrained model name")
    ...
    if args.do_train:
        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for step, batch in enumerate(tqdm_bar):
                ...
                losses = model(input_ids, mc_token_ids=mc_token_ids,
                ...
                tr_loss += loss.item()
                exp_average_loss = (
                    loss.item() if exp_average_loss is None else 0.7 *
    ...
    if args.do_eval:
        ...
        result = {"eval_loss": eval_loss,
                  "eval_accuracy": eval_accuracy, "train_loss": train_loss}
