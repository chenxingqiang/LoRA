...
def main(args):
    ...
    st = torch.load(os.path.join(serialization_dir,
    ...
    for name, param in st.items():
        ...
        if "mask_scores" in name:
            if pruning_method == "topK":
                ...
                mask_ones = ThresholdBinarizer.apply(
                    param, threshold, True).sum().item()
            ...
            print(name.ljust(60, " "), str(round(100 * mask_ones /
                  param.numel(), 3)).ljust(20, " "), str(mask_ones))
        else:
