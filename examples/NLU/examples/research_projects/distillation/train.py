...
def sanity_checks(args):
    ...
    if args.mlm:
        ...
        assert (args.student_type in ["gpt2"]) and (
            args.teacher_type in ["gpt2"])
    ...
    assert args.alpha_ce + args.alpha_mlm + \
...
def main():
    ...
    parser.add_argument("--student_config", type=str,
                        required=True, help="Path to the student configuration.")
    parser.add_argument(
    ...
    parser.add_argument("--teacher_name", type=str,
                        required=True, help="The teacher model.")
    ...
    parser.add_argument("--warmup_prop", default=0.05,
                        type=float, help="Linear warmup proportion.")
    ...
    parser.add_argument("--max_grad_norm", default=5.0,
                        type=float, help="Max gradient norm.")
    parser.add_argument("--initializer_range", default=0.02,
                        type=float, help="Random initialization range.")
    ...
    parser.add_argument("--log_interval", type=int,
                        default=500, help="Tensorboard logging interval.")
    parser.add_argument("--checkpoint_interval", type=int,
                        default=4000, help="Checkpoint interval.")
